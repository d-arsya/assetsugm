...
import AspirasiModal from "@/components/aspirasi-modal";
...
export default function AspirasiCard({ name, angkatan, aspiration }) {
  ...
  return (
    <>
      <div
        className="flex flex-col font-inter py-7 px-7 min-w-[200px] md:w-full min-h-[200px] md:h-[300px] cursor-pointer hover:text-white bg-[#F6F6F6] hover:bg-green-primary border border-[#C6C6C6] rounded-2xl"
        onClick={openModal}
      >
        <div className="flex items-center gap-5 flex-wrap">
          <div className="w-10 h-10 rounded-full overflow-hidden">
            <img src="assets/img/elon.jpg" alt="profile picture" className="object-cover" />
          </div>
          <div>
