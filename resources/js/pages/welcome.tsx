        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="w-full min-h-[90vh] grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="w-[85%] md:w-3/4">
                    <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#115C5B] mb-3 md:mb-5">ASSETS UGM</h1>
                    <h2 className="font-bold text-base sm:text-lg md:text-xl text-[#115C5B] my-3 md:my-5">Associaton of Software Engineering Technology Students</h2>
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#115C5B] mt-3 md:mt-5 font-light">Himpunan Mahasiswa Program Studi Teknologi Rekayasa Perangkat Lunak, Sekolah Vokasi, Universitas Gadjah Mada</p>
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#115C5B] mb-3 md:mb-5 font-light">"Small Organization BIG Impact"</p>
                    <button className="text-xs sm:text-sm md:text-base font-bold bg-[#1D9997] text-white px-4 md:px-5 py-2 flex items-center border-none my-10 md:my-20 cursor-pointer rounded-lg hover:bg-[#187d7b]">
                    See More
                    </button>
                </div>
                </div>
            ...
            <div className="flex flex-col items-center h-screen py-10 mt-40 w-full">
                ...
                <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl text-[#486284] my-5">Kabinet</h1>
                <h2 className="font-bold text-base sm:text-lg md:text-xl text-[#115C5B] text-center">Choose a Cabinet to learn more about ASSETS</h2>
                <p className="text-sm sm:text-base md:text-lg lg:text-xl font-light text-[#115C5B] text-center max-w-xl">Each year, ASSETS organizes a Cabinet dedicated to making TRPL a better place for students and the surrounding community</p>
                </div>
                ...
                {["Kabinet1.png", "Kabinet2.png", "Kabinet3.png"].map((image, index) => (
                    ...
                    className={`w-3 h-3 rounded-full cursor-pointer ${
                        images.indexOf(image) === 1 ? 'bg-[#486284] hover:bg-[#5c7494]' : 'bg-gray-300 hover:bg-gray-400'
            ...
            <div className="flex flex-col items-center h-fit py-20 mt-20">
                <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl text-[#486284] mt-5 mb-40">New Activities</h1>
            ...
            <div className="max-w-4/5 flex flex-col items-center">
                <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl text-[#486284] my-5 mb-20">
                Aspirasi
                </h1>
                ...
                <button className="bg-[#1D9997] text-white rounded-4xl py-3 w-full md:w-auto md:px-[250px] my-20 cursor-pointer hover:bg-[#187d7b] text-xs sm:text-sm md:text-base">
                Tambah Aspirasi
                </button>
            </div>
            </div>
